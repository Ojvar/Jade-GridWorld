...
public class Agent {
	...
	/**
	 * Get current agent position. \returns This will return null if the agent is
	 * not entered in the world.
	 */
	...
	/**
	 * Check if agent is "entered" in the environment. That is, it has a position in
	 * the world. \returns true if agent is entered in the environment
	 */
	 ...
	 * \todo signalMove show become special signal enter/exit
	 */
	public void reset() {
