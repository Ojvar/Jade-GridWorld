...
public class SenseBombMessage extends OneShotBehaviour {
     ...
     * @param bomb
     */
    public SenseBombMessage(BombSweeperAgent agent, Bomb bomb) {
        this.agent = agent;
        this.bomb = bomb;
    }
    ...
    public void action() {
        ...
        String content = String.join(MessageReceiver.SEPARATOR, MessageReceiver.C_NEW_BOMB, agent.getLocalName(),
                bomb.toString());
